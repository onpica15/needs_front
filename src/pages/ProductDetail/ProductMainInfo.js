...
function ProductMainInfo(props) {
    return (
        <Row>
            <Col md={6}>
                <span style={{ paddingLeft: '20px' }}>商品運費</span>
                <div className="card delivery mt-2 border rounded">
                    <table className="table table-borderless m-0 font-s">
                        <tbody>
                            ...
                            <tr>
                                <td colSpan={3}>實際運費金額以購物車結算或到貨時收取的金額為準</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
