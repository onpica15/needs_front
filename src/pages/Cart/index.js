            ...
            <Container>
                ...
                <div className="border rounded-top">
                    <Row className="cart-infobar rounded-top py-3 m-0">
                        ...
                        <Col md={2} className="text-right pr-5">單價</Col>
                        <Col md={3} className="text-center">數量</Col>
                        <Col md={1} className="text-right">小計</Col>
                        <Col md={1} className="text-right"><FaTimes /></Col>
                    </Row>
                    <Row className="cart-item py-3 m-0">
                        <Col md={5} className="d-flex">
                            ...
                            <div className="item-product ml-4 d-flex">
                                <img src={require('../../assets/img/products/1-paper/PT01_300x0.jpg')} />
                                <div className="ml-5">
                        ...
                        <Col md={2} className="text-right align-self-center font-point pr-5">NT780</Col>
                        <Col md={3} className="d-flex">
                            <Form.Group className="mb-0 align-self-center">
                                <div className="btn-group border rounded w-75 quantity-group" role="group" aria-label="Basic example">
                        ...
                        <Col md={1} className="text-right align-self-center font-point">NT780</Col>
                        <Col md={1} className="text-right align-self-center"><FaTimes /></Col>
                    </Row>
                    ...
                    <Row className="cart-item py-3 m-0">
                        <Col md={5} className="d-flex">
                            ...
                            <div className="item-product ml-4 d-flex">
                                <img src={require('../../assets/img/products/1-paper/PT02_300x0.jpg')} />
                                <div className="ml-5">
                                    <p className="item-title">南國的孩子 手寫數字章 (22個入)</p>
                                    <span>規格：單一規格</span>
                                </div>
                ...
                <Row className="delivery-pay-info">
                    <Col md={6}>
                        <div className="border rounded-top cart-infobar p-3">
                            配送方式
                        </div>
                        ...
                        <div className="p-3 border border-top-0 item-title">
                            <div className="d-flex justify-content-between">
                                <div>
                                    <p>商品總計</p>
                                    <p>運費總計</p>
                                    <p className="mb-0">其他折抵 <span className="font-point">（使用Ｅ幣折抵）</span>  </p>                      
                                </div>
