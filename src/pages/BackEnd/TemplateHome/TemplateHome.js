      ...
      <div className="template-home">
        <Col className="offset-2" xs={10}>
            <Container className="w-80">
              ...
              <button className="mt-4 btn-light"><MdVisibility/> 查看目前主頁</button>
              <hr/>
              <h1 className="mt-4">當前主題</h1>
              <button className="mt-3 btn-purple"><MdEdit/> 編輯當前主題</button>

              <div className="main-div rounded mt-5 main-adjust">
              <div className="col-6">
              <div className="d-flex flex-column">
                    <img src={TemplatepicBig} className="img-fluid bg-img" alt="Responsive image"></img>
